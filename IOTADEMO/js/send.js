...
$(document).ready(function() {
    ...
    function sendTransfer(address, value, messageTrytes) {
        ...
        iota.api.sendTransfer(seed, 1, 14, transfer, function(e) {
    ...
    $("#submit").on("click", function() {
        ...
        var hour    = String(datenow.getHours());
        var minute  = String(datenow.getMinutes());
        var second  = String(datenow.getSeconds());
